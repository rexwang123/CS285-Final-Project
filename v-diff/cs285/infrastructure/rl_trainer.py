    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample, save_expert_data_to_disk=False):
        ...
        if itr == 0:
            if initial_expertdata:
                ...
                num_transitions_to_sample = 2 * self.params['batch_size_initial'] + 1
        else:
            num_transitions_to_sample = 2 * self.params['batch_size'] + 1
    ...
    def train_agent(self, itr):
        ...
        if itr < 0:
          for train_step in range(self.params['num_agent_train_steps_per_iter']):
              ob_batch1, ac_batch1, re_batch1, next_re_batch1, next_ob_batch1, terminal_batch1, ob_batch2, ac_batch2, re_batch2, next_ob_batch2, terminal_batch2 = self.agent.sample(self.params['train_batch_size'])
              train_log = self.agent.train(ob_batch1, ac_batch1, re_batch1, next_re_batch1, next_ob_batch1, terminal_batch1, ob_batch2, ac_batch2, re_batch2, next_ob_batch2, terminal_batch2, True)
              all_logs.append(train_log)
        else:
          for train_step in range(self.params['num_agent_train_steps_per_iter']):
              ob_batch1, ac_batch1, re_batch1, next_re_batch1, next_ob_batch1, terminal_batch1, ob_batch2, ac_batch2, re_batch2, next_ob_batch2, terminal_batch2 = self.agent.sample(self.params['train_batch_size'])
              train_log = self.agent.train(ob_batch1, ac_batch1, re_batch1, next_re_batch1, next_ob_batch1, terminal_batch1, ob_batch2, ac_batch2, re_batch2, next_ob_batch2, terminal_batch2, False)
              all_logs.append(train_log)
        return all_logs
    ####################################
    ####################################
